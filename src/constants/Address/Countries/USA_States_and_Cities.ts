...
export const USA_CITIES_BY_STATE =   [
        { "city": "Abbeville", "state": "Louisiana", "value": "LA" },
...
export const LOUISIANA_PARISHES = [
        {value: "01", name: "Acadia"},
        {value: "02", name: "Allen"},
        {value: "03", name: "Ascension"},
        {value: "04", name: "Assumption"},
        {value: "05", name: "Avoyelles"},
        {value: "06", name: "Beauregard"},
        {value: "07", name: "Bienville"},
        {value: "08", name: "Bossier"},
        {value: "09", name: "Caddo"},
        {value: "10", name: "Calcasieu"},
        {value: "11", name: "Caldwell"},
        {value: "12", name: "Cameron"},
        {value: "13", name: "Catahoula"},
        {value: "14", name: "Claiborne"},
        {value: "15", name: "Concordia"},
        {value: "16", name: "DeSoto"},
        {value: "17", name: "East Baton Rouge"},
        {value: "18", name: "East Carroll"},
        {value: "19", name: "East Feliciana"},
        {value: "20", name: "Evangeline"},
        {value: "21", name: "Franklin"},
        {value: "22", name: "Grant"},
        {value: "23", name: "Iberia"},
        {value: "24", name: "Iberville"},
        {value: "25", name: "Jackson"},
        {value: "26", name: "Jefferson"},
        {value: "27", name: "Jefferson Davis"},
        {value: "28", name: "Lafayette"},
        {value: "29", name: "Lafourche"},
        {value: "30", name: "LaSalle"},
        {value: "31", name: "Lincoln"},
        {value: "32", name: "Livingston"},
        {value: "33", name: "Madison"},
        {value: "34", name: "Morehouse"},
        {value: "35", name: "Natchitoches"},
        {value: "36", name: "Orleans"},
        {value: "37", name: "Ouachita"},
        {value: "38", name: "Plaquemines"},
        {value: "39", name: "Pointe Coupee"},
        {value: "40", name: "Rapides"},
        {value: "41", name: "Red River"},
        {value: "42", name: "Richland"},
        {value: "43", name: "Sabine"},
        {value: "44", name: "St. Bernard"},
        {value: "45", name: "St. Charles"},
        {value: "46", name: "St. Helena"},
        {value: "47", name: "St. James"},
        {value: "48", name: "St. John"},
        {value: "49", name: "St. Landry"},
        {value: "50", name: "St. Martin"},
        {value: "51", name: "St. Mary"},
        {value: "52", name: "St. Tammany"},
        {value: "53", name: "Tangipahoa"},
        {value: "54", name: "Tensas"},
        {value: "55", name: "Terrebonne"},
        {value: "56", name: "Union"},
        {value: "57", name: "Vermilion"},
        {value: "58", name: "Vernon"},
        {value: "59", name: "Washington"},
        {value: "60", name: "Webster"},
        {value: "61", name: "West Baton Rouge"},
        {value: "62", name: "West Carroll"},
        {value: "63", name: "West Feliciana"},
        {value: "64", name: "Winn"}
];

function getStateFullNameFromStateCode(stateCode: string) {
    if(!stateCode) {
        return "Alabama";
    } else if(stateCode.length > 2) {
        return stateCode;
    } else {
        return USA_STATES.find(item => item.value === stateCode)?.name;
    }
}
 ...
 * Helpers
 * */
export const getUSACitiesByState = (requestedState: string) => USA_CITIES_BY_STATE
    .filter((item) => item.state === getStateFullNameFromStateCode(requestedState))
    .map(city => ({
            ...city,
            name: city.city,
            value: city.city,
...
export const getParishFullName = (parishCode: string) => {
    return LOUISIANA_PARISHES.find(item => item.value === parishCode)?.name;
}